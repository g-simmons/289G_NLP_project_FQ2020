...
if __name__ == "__main__":
    ...
    def collate_func(data):
        ...
        for index in range(len(data)):
            ...
            text_list.append(curr_sample["text"])                                   #Bert modified 2
        ...
        text_list = [text_list[index] for index in argsort_list]                        #BERT Modified 2
        ...
        if len(data) == 1:
            ...
            the_batch_sample["text"] = text_list[0]                                #BERT modified 2
        ...
        # if the batch is > 1, then we need to pad the input so that they all have the same dimensions
            ...
            the_batch_sample["text"] = text_list                               #BERT modified 2
